package com.joe.common.widget;

/**
 * @author Joe
 * @time 9/27/2018 10:44 AM
 */
...
public class CircleTextProgressbar extends android.support.v7.widget.AppCompatTextView {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        if (typedArray.hasValue(R.styleable.CircleTextProgressbar_in_circle_color)) {
            ...
            outLineColor = typedArray.getColor(R.styleable.CircleTextProgressbar_out_line_color, Color.WHITE);
            progressLineColor = typedArray.getColor(R.styleable.CircleTextProgressbar_progress_color, Color.WHITE);
            progressLineWidth = typedArray.getDimensionPixelSize(R.styleable.CircleTextProgressbar_out_line_width, 3);
        } else {
