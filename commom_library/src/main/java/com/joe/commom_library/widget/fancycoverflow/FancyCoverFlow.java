package com.joe.commom_library.widget.fancycoverflow;
...
public class FancyCoverFlow extends Gallery {
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        this.unselectedAlpha = a.getFloat(
                R.styleable.FancyCoverFlow_unselectedAlpha, 1.0f);
        this.unselectedSaturation = a.getFloat(
                R.styleable.FancyCoverFlow_unselectedSaturation, 1.0f);
